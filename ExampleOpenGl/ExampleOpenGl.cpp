...
*/
    ...
    glBegin(GL_LINES);
		...
		for(unsigned int i = 25; i < N-10; i += 50)
		{
	...
	output(x0+1, (3.846153*0.66666*cntrlpointsP[0][1])+4 , "160");
	output(x0+1, (3.846153*cntrlpointsP[0][2]/2)+4 , "156");
	output(x0+1, (3.846153*cntrlpointsP[0][3]/3)+4 , "151.99");
...
*/
	...
	char it[]={"0.4  0.8  1.2  1.6  2   2.4  2.8  3   3.4  3.8  4.2  4.6  5   5.4  5.8  6.2  6.6  7   7.2"};
...
int main(int argc, char** argv)
{
	...
	glutDisplayFunc(displayMeTpar);
    glutMainLoop();

	glutDisplayFunc(displayMeTjyd);
    glutMainLoop();
